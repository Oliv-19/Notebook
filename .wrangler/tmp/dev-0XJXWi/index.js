...
app.post("/api/upload-pdf", async (c) => {
  try {
    ...
    const pageImgUrls = data.Files.map((file2) => file2.Url);
...
// .wrangler/tmp/bundle-XPlFJI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-XPlFJI/middleware-loader.entry.ts

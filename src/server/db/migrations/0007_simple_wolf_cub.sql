...
CREATE TABLE `__new_notebook_user` (
	...
	`canvas_info` text,
	`created_at` integer DEFAULT '"2026-07-25T13:35:36.373Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-25T13:35:36.373Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-07-25T13:35:36.356Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-25T13:35:36.356Z"' NOT NULL
);
--> statement-breakpoint

...
CREATE TABLE `__new_notebook_user` (
	...
	`name` text DEFAULT '"2026-07-21T11:31:44.168Z"',
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-07-21T11:31:44.167Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-07-21T11:31:44.167Z"' NOT NULL
);
--> statement-breakpoint
